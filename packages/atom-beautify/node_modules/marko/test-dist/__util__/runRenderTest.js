            ...
            var verifyOutput = function (result) {
                ...
                if (isVDOM) {
                    var getExpectedHtml = function (callback) {
                        ...
                        require("marko/compiler").configure(Object.assign({}, compilerOptions, {
                            output: "html"
                        }));

                        require("marko/runtime/vdom/AsyncVDOMBuilder").prototype.v_ = defaultDocument;
                        global.document = defaultDocument;
                        ...
                        expectedHtml = domToString(browser.window.document.body, { childrenOnly: true });
